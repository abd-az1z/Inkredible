...
const FilterBar = ({
  ...
  const handleRatingChange = (event) => {
    onFilterChange({ ratings: event.target.value });
  };

  const handleSleeveLengthChange = (event) => {
    const selectedLength = event.target.value;
    const newSleeveLength = selectedLength;
    onFilterChange({ sleeveLength: newSleeveLength });
  };
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed top-[8.2%] left-0 w-64 h-full opacity-90 bg-gray-100 z-50 p-6 shadow-lg md:hidden"
      >
        ...
        <div className="w-full text-sm">
          {/* Filter by Size (Checkboxes for multi-selection) */}
          <div className="mb-4">
          ...
          {/* Filter by Price (Checkboxes for multi-selection) */}
          <div className="mb-4">
      ...
      <div className="hidden md:block w-[100%] h-full bg-gray-100 p-6">
        <h2 className="text-extrabold mb-6">Filters</h2>
        <div className="w-full text-sm">
