...
function WomenCategory() {
  ...
  useEffect(() => {
    fetchByCategory("Women"); // Fetch only women's products when this component loads
  }, [fetchByCategory]);

  const filteredProducts = products
    .filter((product) => product.category === "Women") // Only include products in the "Men" category
    .filter((product) => {
      if (
    ...
    <div className="w-full min-h-screen">
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="md:w-[85%] w-full md:m-4 overflow-hidden">
          <h1 className="text-3xl px-2 font-bold mb-6">Shop For Women</h1>
